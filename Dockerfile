...
RUN ARCH="$(dpkg --print-architecture)" \
    ...
    && apt-get update && apt-get install -y xz-utils ca-certificates rclone tmux ripgrep \
...
# Install pnpm, mcporter, clawhub globally
RUN npm install -g pnpm mcporter clawhub
